...
minutes = int(input("Enter the time in minutes the lasagna has been in the oven: "))
remaining_time = 40 - minutes
print("The lasagna needs to bake for", remaining_time, "more minutes.")
...
more_minutes = int(input("Enter the number of layers you want to add: ")) * 2
print("The lasagna needs", more_minutes, "more minutes to prepare.")
...
print("Total time lasagna needs:", more_minutes + remaining_time, "minutes.")
...
value_of_single_bill = int(input("Enter the value of a single bill: "))
number_of_bill = int(input("Enter the number of bills: "))
total_value = value_of_single_bill * number_of_bill
print("The total value of the bills is:", total_value)
...
slope = (y2 - y1) / (x2 - x1)
print("The value of the floor slope is", int(slope))
...
total_savings = int(input("Enter the total savings: "))
exchanging_amount = int(input("Enter the exchanging amount: "))
remaining_amount = total_savings - exchanging_amount
print("The remaining amount in savings is:", remaining_amount)
...
p1 = float(input("Enter the first probability: "))
p2 = float(input("Enter the second probability: "))
p3 = float(input("Enter the third probability: "))
print(p1 + p2 + p3 == 1)
